...
from tournament.models import Team, Department, Player
...
class TeamForm(forms.ModelForm):
    deptName = forms.ModelChoiceField(queryset=Department.objects.all(), empty_label="Select Department", required=True, widget=forms.Select(
        attrs={
